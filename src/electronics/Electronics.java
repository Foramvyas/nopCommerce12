...
public class Electronics extends TopMenuTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"), "samira.edward" + randomInt + "@gmail.com");
        Thread.sleep(2000);
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"), "Mrs.Samira Dave");
        Thread.sleep(1000);
