...
public class TestSuite extends TopMenuTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        Thread.sleep(1000);
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_FirstName']"),"Samira");
        Thread.sleep(1000);
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_LastName']"),"Edward");
        Thread.sleep(1000);
        sendTextToElement(By.xpath("//input[@id='BillingNewAddress_Email']"),"samira.edward12@gmail.com");
        Thread.sleep(2000);
        ...
        sendTextToElement(By.xpath("//input[@id='CardholderName']"),"Mrs.Samira Edward");
        Thread.sleep(1000);
